...
use {Ipv4Address, Ipv4Mask};

impl Ipv4Address {
    pub fn min_value() -> Ipv4Address {
        u32::min_value().into()
    }

    pub fn max_value() -> Ipv4Address {
        u32::max_value().into()
    }

    pub fn from_str_radix(src: &str, radix: u32) -> Result<Ipv4Address, ParseIntError> {
        u32::from_str_radix(src, radix).map(Ipv4Address)
    }
    ...
    pub fn rotate_left(self, n: u32) -> Ipv4Address {
        self.0.rotate_left(n).into()
    }

    pub fn rotate_right(self, n: u32) -> Ipv4Address {
        self.0.rotate_right(n).into()
    }

    pub fn swap_bytes(self) -> Ipv4Address {
        self.0.swap_bytes().into()
    }

    // pub fn reverse_bits(self) -> Ipv4Address {
    //     self.0.reverse_bits().into()
    // }

    pub fn checked_add(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_add(rhs).map(Ipv4Address)
    }

    pub fn checked_sub(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_sub(rhs).map(Ipv4Address)
    }

    pub fn checked_mul(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_mul(rhs).map(Ipv4Address)
    }

    pub fn checked_div(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_div(rhs).map(Ipv4Address)
    }

    // pub fn checked_div_euc(self, rhs: u32) -> Option<Ipv4Address> {
    //     self.0.checked_div_euc(rhs).map(Ipv4Address)
    // }

    pub fn checked_rem(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_rem(rhs).map(Ipv4Address)
    }

    // pub fn checked_mod_euc(self, rhs: u32) -> Option<Ipv4Address> {
    //     self.0.checked_mod_euc(rhs).map(Ipv4Address)
    // }

    pub fn checked_neg(self) -> Option<Ipv4Address> {
        self.0.checked_neg().map(Ipv4Address)
    }

    pub fn checked_shl(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_shl(rhs).map(Ipv4Address)
    }

    pub fn checked_shr(self, rhs: u32) -> Option<Ipv4Address> {
        self.0.checked_shr(rhs).map(Ipv4Address)
    }

    // pub fn checked_pow(self, rhs: u32) -> Option<Ipv4Address> {
    //     self.0.checked_pow(rhs).map(Ipv4Address)
    // }

    pub fn saturating_add(self, rhs: u32) -> Ipv4Address {
        self.0.saturating_add(rhs).into()
    }

    pub fn saturating_sub(self, rhs: u32) -> Ipv4Address {
        self.0.saturating_sub(rhs).into()
    }

    pub fn saturating_mul(self, rhs: u32) -> Ipv4Address {
        self.0.saturating_mul(rhs).into()
    }

    pub fn wrapping_add(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_add(rhs).into()
    }

    pub fn wrapping_sub(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_sub(rhs).into()
    }

    pub fn wrapping_mul(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_mul(rhs).into()
    }

    pub fn wrapping_div(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_div(rhs).into()
    }

    // pub fn wrapping_div_euc(self, rhs: u32) -> Ipv4Address {
    //     self.0.wrapping_div_euc(rhs).into()
    // }

    pub fn wrapping_rem(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_rem(rhs).into()
    }

    // pub fn wrapping_mod_euc(self, rhs: u32) -> Ipv4Address {
    //     self.0.wrapping_mod_euc(rhs).into()
    // }

    pub fn wrapping_neg(self) -> Ipv4Address {
        self.0.wrapping_neg().into()
    }

    pub fn wrapping_shl(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_shl(rhs).into()
    }

    pub fn wrapping_shr(self, rhs: u32) -> Ipv4Address {
        self.0.wrapping_shr(rhs).into()
    }

    // pub fn wrapping_pow(self, rhs: u32) -> Ipv4Address {
    //     self.0.wrapping_pow(rhs).into()
    // }

    pub fn overflowing_add(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_add(rhs);
        (i.into(), b)
    }

    pub fn overflowing_sub(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_sub(rhs);
        (i.into(), b)
    }

    pub fn overflowing_mul(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_mul(rhs);
        (i.into(), b)
    }

    pub fn overflowing_div(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_div(rhs);
        (i.into(), b)
    }

    // pub fn overflowing_div_euc(self, rhs: u32) -> (Ipv4Address, bool) {
    //     self.0.overflowing_div_euc(rhs).map(|res| (res.0.into(), res.1))
    //     (i.into(), b)
    // }

    pub fn overflowing_rem(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_rem(rhs);
        (i.into(), b)
    }

    // pub fn overflowing_mod_euc(self, rhs: u32) -> (Ipv4Address, bool) {
    //     self.0.overflowing_mod_euc(rhs).map(|res| (res.0.into(), res.1))
    //    (i.into(), b)
    // }

    pub fn overflowing_neg(self) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_neg();
        (i.into(), b)
    }

    pub fn overflowing_shl(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_shl(rhs);
        (i.into(), b)
    }

    pub fn overflowing_shr(self, rhs: u32) -> (Ipv4Address, bool) {
        let (i, b) = self.0.overflowing_shr(rhs);
        (i.into(), b)
    }

    // pub fn overflowing_pow(self, rhs: u32) -> (Ipv4Address, bool) {
...
// FIXME does it make send to impl Deref and/or Borrow traits for u32 ?
...
impl Add for Ipv4Address {
    ...
    fn add(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.add(rhs.0))
    }
}

impl<'a> Add<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn add(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.add(rhs.0))
    }
}
...
impl<'a> Add<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn add(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.add(rhs.0))
    }
}
...
impl<'a, 'b> Add<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn add(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.add(rhs.0))
    }
}
...
impl AddAssign for Ipv4Address {
    fn add_assign(&mut self, rhs: Ipv4Address) {
        self.0.add_assign(rhs.0)
    }
}

impl<'a> AddAssign<&'a Ipv4Address> for Ipv4Address {
    fn add_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.add_assign(rhs.0)
    }
}
...
impl Sub for Ipv4Address {
    type Output = Ipv4Address;
    fn sub(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.sub(rhs.0))
    }
}

impl<'a> Sub<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn sub(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.sub(rhs.0))
    }
}
...
impl<'a> Sub<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn sub(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.sub(rhs.0))
    }
}
...
impl<'a, 'b> Sub<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn sub(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.sub(rhs.0))
    }
}
...
impl SubAssign for Ipv4Address {
    fn sub_assign(&mut self, rhs: Ipv4Address) {
        self.0.sub_assign(rhs.0)
    }
}

impl<'a> SubAssign<&'a Ipv4Address> for Ipv4Address {
    fn sub_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.sub_assign(rhs.0)
    }
}
...
impl Div for Ipv4Address {
    type Output = Ipv4Address;
    fn div(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.div(rhs.0))
    }
}

impl<'a> Div<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn div(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.div(rhs.0))
    }
}
...
impl<'a> Div<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn div(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.div(rhs.0))
    }
}
...
impl<'a, 'b> Div<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn div(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.div(rhs.0))
    }
}
...
impl DivAssign for Ipv4Address {
    fn div_assign(&mut self, rhs: Ipv4Address) {
        self.0.div_assign(rhs.0)
    }
}

impl<'a> DivAssign<&'a Ipv4Address> for Ipv4Address {
    fn div_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.div_assign(rhs.0)
    }
}
...
impl Rem for Ipv4Address {
    type Output = Ipv4Address;
    fn rem(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.rem(rhs.0))
    }
}

impl<'a> Rem<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn rem(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.rem(rhs.0))
    }
}
...
impl<'a> Rem<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn rem(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.rem(rhs.0))
    }
}
...
impl<'a, 'b> Rem<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn rem(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.rem(rhs.0))
    }
}
...
impl<'a> Rem<&'a u32> for Ipv4Address {
    type Output = Ipv4Address;
    fn rem(self, rhs: &'a u32) -> Self::Output {
        Ipv4Address(self.0.rem(rhs))
    }
}
...
impl RemAssign for Ipv4Address {
    fn rem_assign(&mut self, rhs: Ipv4Address) {
        self.0.rem_assign(rhs.0)
    }
}

impl<'a> RemAssign<&'a Ipv4Address> for Ipv4Address {
    fn rem_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.rem_assign(rhs.0)
    }
}
...
impl Mul for Ipv4Address {
    type Output = Ipv4Address;
    fn mul(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.mul(rhs.0))
    }
}

impl<'a> Mul<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn mul(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.mul(rhs.0))
    }
}
...
impl<'a> Mul<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn mul(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.mul(rhs.0))
    }
}
...
impl<'a, 'b> Mul<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn mul(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.mul(rhs.0))
    }
}
...
impl MulAssign for Ipv4Address {
    fn mul_assign(&mut self, rhs: Ipv4Address) {
        self.0.mul_assign(rhs.0)
    }
}

impl<'a> MulAssign<&'a Ipv4Address> for Ipv4Address {
    fn mul_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.mul_assign(rhs.0)
    }
}
...
impl BitAnd for Ipv4Address {
    type Output = Ipv4Address;
    fn bitand(self, rhs: Ipv4Address) -> Self {
...
impl<'a> BitAnd<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn bitand(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.bitand(rhs.0))
    }
}
...
impl<'a, 'b> BitAnd<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn bitand(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.bitand(rhs.0))
    }
}
...
impl<'a> BitAnd<&'a u32> for Ipv4Address {
    type Output = Ipv4Address;
    fn bitand(self, rhs: &'a u32) -> Self::Output {
        Ipv4Address(self.0.bitand(rhs))
    }
}
...
impl BitAndAssign for Ipv4Address {
    fn bitand_assign(&mut self, rhs: Ipv4Address) {
        self.0.bitand_assign(rhs.0)
    }
}

impl<'a> BitAndAssign<&'a Ipv4Address> for Ipv4Address {
    fn bitand_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.bitand_assign(rhs.0)
    }
}
...
impl BitOr for Ipv4Address {
    type Output = Ipv4Address;
    fn bitor(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.bitor(rhs.0))
    }
}
...
impl<'a> BitOr<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn bitor(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.bitor(rhs.0))
    }
}
...
impl<'a, 'b> BitOr<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn bitor(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.bitor(rhs.0))
    }
}
...
impl<'a> BitOr<&'a u32> for Ipv4Address {
    type Output = Ipv4Address;
    fn bitor(self, rhs: &'a u32) -> Self::Output {
        Ipv4Address(self.0.bitor(rhs))
    }
}
...
impl BitOrAssign for Ipv4Address {
    fn bitor_assign(&mut self, rhs: Ipv4Address) {
        self.0.bitor_assign(rhs.0)
    }
}

impl<'a> BitOrAssign<&'a Ipv4Address> for Ipv4Address {
    fn bitor_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.bitor_assign(rhs.0)
    }
}
...
impl BitXor for Ipv4Address {
    type Output = Ipv4Address;
    fn bitxor(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.bitxor(rhs.0))
    }
}
...
impl<'a> BitXor<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn bitxor(self, rhs: &'a Ipv4Address) -> Self {
        Ipv4Address(self.0.bitxor(rhs.0))
    }
}
...
impl<'a, 'b> BitXor<&'a Ipv4Address> for &'b Ipv4Address {
    type Output = Ipv4Address;
    fn bitxor(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.bitxor(rhs.0))
    }
}
...
impl<'a> BitXor<&'a u32> for Ipv4Address {
    type Output = Ipv4Address;
    fn bitxor(self, rhs: &'a u32) -> Self::Output {
        Ipv4Address(self.0.bitxor(rhs))
    }
}
...
impl BitXorAssign for Ipv4Address {
    fn bitxor_assign(&mut self, rhs: Ipv4Address) {
        self.0.bitxor_assign(rhs.0)
    }
}

impl<'a> BitXorAssign<&'a Ipv4Address> for Ipv4Address {
    fn bitxor_assign(&mut self, rhs: &'a Ipv4Address) {
        self.0.bitxor_assign(rhs.0)
    }
}
...
impl Shl for Ipv4Address {
    type Output = Ipv4Address;
    fn shl(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.shl(rhs.0))
    }
}

impl<'a> Shl<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn shl(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.shl(rhs.0))
    }
}
...
impl<'a> Shl<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn shl(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.shl(rhs.0))
    }
}
...
impl Shr for Ipv4Address {
    type Output = Ipv4Address;
    fn shr(self, rhs: Ipv4Address) -> Self {
        Ipv4Address(self.0.shr(rhs.0))
    }
}

impl<'a> Shr<Ipv4Address> for &'a Ipv4Address {
    type Output = Ipv4Address;
    fn shr(self, rhs: Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.shr(rhs.0))
    }
}
...
impl<'a> Shr<&'a Ipv4Address> for Ipv4Address {
    type Output = Ipv4Address;
    fn shr(self, rhs: &'a Ipv4Address) -> Self::Output {
        Ipv4Address(self.0.shr(rhs.0))
    }
}
...
impl From<Ipv4Mask> for Ipv4Address {
    fn from(value: Ipv4Mask) -> Self {
        Ipv4Address(value.into())
    }
}

impl<'a> From<&'a Ipv4Mask> for Ipv4Address {
    fn from(value: &'a Ipv4Mask) -> Self {
        Ipv4Address(value.into())
    }
}
